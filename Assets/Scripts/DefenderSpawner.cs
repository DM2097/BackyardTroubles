...
public class DefenderSpawner : MonoBehaviour
{
    ...
    void OnMouseDown()
    {
        ...
        {
            testifenoughstars(true);
            SpawnDefender(roundedPos, defender);

        }
        else
        {
            testifenoughstars(false);
            
        }
    }
    void testifenoughstars(bool test)
    {
        if (test == false)
        {
            Debug.LogWarning("Insufficient stars to spawn");
        }
        else
        {
            Debug.LogWarning("Sufficient stars to spawn");
        }
    }
